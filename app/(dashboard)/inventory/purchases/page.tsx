...
import { TrendingDown, Plus, FileText, Truck } from 'lucide-react';
...
export default async function PurchasesPage() {
  ...
  const [purchases, stats] = await Promise.all([getPurchases(), getPurchaseStats()]);
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">{formatCurrency(stats.unpaidTotal)}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Đơn nhập gần đây</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>100 phiếu nhập gần nhất</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
          ...
          {purchases.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">Tạo phiếu nhập đầu tiên</p>
              <Button asChild>
                <Link href="/inventory/purchases/add">
                  <Plus className="mr-2 h-4 w-4" />
                  Tạo phiếu nhập
